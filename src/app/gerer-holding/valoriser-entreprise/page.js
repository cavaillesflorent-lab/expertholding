...
import { TrendingUp, Shield, CheckCircle, ArrowRight, FileText, Users, Award, Target, Calculator, Gift } from 'lucide-react'

export default function ValoriserEntreprisePage() {
  const LIEN_BILAN_VALORISATION = "https://taap.it/eyGWUj"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* NOUVELLE SECTION : Que vaut mon entreprise ? */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <div className="flex items-center mb-6">
                <div className="w-14 h-14 bg-amber-500/20 rounded-xl flex items-center justify-center mr-4">
              ...
              <p className="text-xl font-light text-slate-300 mb-6 leading-relaxed">
                C'est LA question que se pose tout dirigeant d'entreprise, que ce soit pour préparer une cession, anticiper une transmission, ou simplement mesurer le chemin parcouru.
              </p>

              <p className="text-lg font-light text-slate-300 mb-6 leading-relaxed">
                Connaître la <strong className="text-white">valeur réelle</strong> de votre holding n'est pas un exercice de curiosité : c'est un <strong className="text-white">outil de pilotage stratégique</strong>. Une valorisation objective vous permet de :
              </p>

              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="text-amber-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-slate-300 font-light">Négocier sereinement lors d'une cession ou d'une levée de fonds</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-amber-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-slate-300 font-light">Préparer une transmission familiale optimisée fiscalement</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-amber-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-slate-300 font-light">Sécuriser vos déclarations fiscales (IFI, donations, successions)</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-amber-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-slate-300 font-light">Mesurer votre création de valeur dans le temps</span>
                </li>
              </ul>

              <p className="text-lg font-light text-slate-300 mb-6">
                Pourtant, trop peu de dirigeants disposent d'une <strong className="text-white">évaluation professionnelle à jour</strong>. Les méthodes approximatives ou "au doigt mouillé" peuvent coûter cher : surévaluation qui fait fuir les acquéreurs, sous-évaluation qui vous fait perdre des centaines de milliers d'euros, ou pire encore, redressement fiscal.
              </p>
            </div>

            {/* Bloc droit : Offre */}
            <div>
              <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-2xl border border-amber-100">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-2xl font-light text-slate-900">Estimation gratuite</h3>
                      <p className="text-sm text-slate-500 font-light">Valeur : 500 à 1 000 €</p>
                    </div>
                  </div>
                  <div className="hidden sm:block">
                    <div className="bg-amber-50 rounded-lg px-4 py-2">
                      <span className="text-amber-600 font-normal text-sm">OFFERT</span>
                    </div>
                  </div>
                </div>

                <div className="border-t border-slate-100 pt-6 mb-6">
                  <h4 className="text-lg font-normal text-slate-900 mb-4">Ce que vous recevez :</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start text-slate-700">
                      <CheckCircle className="text-green-600 mr-3 mt-0.5 flex-shrink-0" size={18} />
                      <span className="font-light text-sm">Estimation préliminaire de la valeur de votre holding</span>
                    </li>
                    <li className="flex items-start text-slate-700">
                      <CheckCircle className="text-green-600 mr-3 mt-0.5 flex-shrink-0" size={18} />
                      <span className="font-light text-sm">Analyse des méthodes applicables à votre situation</span>
                    </li>
                    <li className="flex items-start text-slate-700">
                      <CheckCircle className="text-green-600 mr-3 mt-0.5 flex-shrink-0" size={18} />
                      <span className="font-light text-sm">Identification des optimisations fiscales possibles</span>
                    </li>
                    <li className="flex items-start text-slate-700">
                      <CheckCircle className="text-green-600 mr-3 mt-0.5 flex-shrink-0" size={18} />
                      <span className="font-light text-sm">Entretien personnalisé de 30 minutes</span>
                    </li>
                    <li className="flex items-start text-slate-700">
                      <CheckCircle className="text-green-600 mr-3 mt-0.5 flex-shrink-0" size={18} />
                      <span className="font-light text-sm">Sans engagement, 100% confidentiel</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-gradient-to-r from-amber-50 to-slate-50 rounded-lg p-4 mb-6">
                  <p className="text-sm font-light text-slate-700 text-center">
                    <strong className="text-amber-600">Offre exclusive</strong> — Normalement facturée entre 500€ et 1 000€, cette estimation préliminaire vous est offerte pour vous aider à y voir plus clair sur la valeur de votre patrimoine professionnel.
                  </p>
                </div>

                <a 
                  href={LIEN_BILAN_VALORISATION}
                  className="w-full inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-8 py-4 text-base font-light transition-all hover:shadow-xl hover:scale-105 rounded-lg"
                >
                ...
                <p className="text-xs text-slate-500 font-light text-center mt-4">
                  Réponse sous 48h • Aucune carte bancaire requise
                </p>
              </div>

              {/* Témoignage / Trust badges */}
              <div className="mt-6 flex items-center justify-center space-x-8 text-sm text-white/80 font-light">
      ...
      {/* CTA Final */}
      <section className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden border-t border-white/10">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
            Une question sur la valorisation ?
          </h2>
          <p className="text-xl font-light text-slate-300 mb-12 max-w-2xl mx-auto">
            Prenez rendez-vous pour un échange sans engagement sur votre projet
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
            <a href="/contact" className="px-8 py-4 bg-amber-500 text-slate-900 font-light hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20 rounded-lg">
              Prendre rendez-vous
            </a>
            <a href="tel:0607963135" className="px-8 py-4 border border-white/20 text-white font-light hover:bg-white/10 transition-all rounded-lg">
              06 07 96 31 35
            </a>
          </div>
